...
<div class="adm-content">
  ...
  <div class="breadcrumb">
    ...
    <span class="breadcrumb-sep">›</span>
    <a href="/lottorank/admin/notice/view/<%= editingPostNo %>"><%= post != null ? org.springframework.web.util.HtmlUtils.htmlEscape(post.getTitle().length() > 20 ? post.getTitle().substring(0,20) + "…" : post.getTitle()) : "게시글" %></a>
    <span class="breadcrumb-sep">›</span>
    <span>수정</span>
  </div>
  ...
  <div class="write-card">
    ...
    <form class="write-form" action="/lottorank/admin/notice/edit/<%= editingPostNo %>" method="post"
      ...
      <div class="form-actions">
        <a href="/lottorank/admin/notice/view/<%= editingPostNo %>" class="btn-cancel">취소</a>
