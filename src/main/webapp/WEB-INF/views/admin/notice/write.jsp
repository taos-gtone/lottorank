...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .nav-item > a:hover, .nav-item > span:hover { background: rgba(0,0,0,0.08); color: var(--g8); }
    ...
    .btn-img-attach {
      ...
      padding: 5px 12px; background: #fff; border: 1px solid var(--g4);
      border-radius: 6px; font-size: 0.8rem; font-weight: 600; color: var(--g6);
    ...
    .btn-align {
      width: 28px; height: 28px; padding: 0; background: #fff;
      border: 1px solid var(--g4); border-radius: 5px; cursor: pointer;
      font-size: 0.75rem; color: var(--g6); display: inline-flex; align-items: center; justify-content: center;
...
<div class="adm-content">
  ...
  <div class="breadcrumb">
    ...
    <a href="/lottorank/admin/notice/list">공지사항</a>
    <span class="breadcrumb-sep">›</span>
    <span>새 공지 작성</span>
  </div>

  <div class="write-card">
    <div class="write-card-header">✏️ 새 공지 작성</div>
    <form class="write-form" action="/lottorank/admin/notice/write" method="post"
      ...
      <div class="form-actions">
        <a href="/lottorank/admin/notice/list" class="btn-cancel">취소</a>
  ...
  <div class="list-card">
    <div class="list-card-header">📢 공지사항 목록</div>
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a class="post-title-link" href="/lottorank/admin/notice/view/<%= lp.getPostNo() %>?page=<%= cp %>">
